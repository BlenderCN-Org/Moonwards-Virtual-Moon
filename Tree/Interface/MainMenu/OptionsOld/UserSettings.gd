...
var text_edit2 : String = "ModelDisplay/UsernameTextEdit2"
...
func _ready() -> void:
	...
	get_node(text_edit2).text = username
	switch_slot()
...
func _on_UsernameTextEdit2_text_changed(new_text : String) -> void:
	...
	Log.trace(self, "_on_UsernameTextEdit2_text_changed", "Change player's name.'")
